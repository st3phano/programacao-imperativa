...
/**
 * Calcula os campos 'total_vendas' para 'Produto' e 'Vendedor' utilizando o 'Vetor_Vendas', retorna o total geral das vendas
 */
...
/**
 * Retorna o total geral das vendas utilizando o campo 'total_vendas' do 'Produto'
 */
